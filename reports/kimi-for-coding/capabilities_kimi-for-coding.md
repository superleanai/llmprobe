# Model capability probe: kimi-for-coding
...
| ask_user_question | FAIL | `ask_user_question` | `run_shell_command` | called 'run_shell_command' instead of 'ask_user_question' |
...
|---|---|---|---|---|
| large_log_grep | PASS | `run_shell_command` | {"command": "grep -nF 'FATAL ERROR' /var/log/app.log"} | command includes a filtering tool (grep/awk/sed/head/tail/wc/cut) |
...
- `TSEL_ask_user_question` FAILED — called 'run_shell_command' instead of 'ask_user_question'.
