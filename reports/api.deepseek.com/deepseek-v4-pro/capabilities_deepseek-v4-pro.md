...
|---|---|---|---|---|
| `openai-completions` | rejected | — | — | rejects `tool_search` — HTTP 400: Failed to deserialize the JSON body into the target type: tools[4].type: unknown variant `tool_search`, expected `function` at line 1 column 22163 invalid_request_error None invalid_reque... |
| `openai-responses` | accepted-but-ignored | 90 / 4956 / 4956 | direct_call | tool schemas cost 4866 input tokens inline; deferring them changed the prompt by 0 |
