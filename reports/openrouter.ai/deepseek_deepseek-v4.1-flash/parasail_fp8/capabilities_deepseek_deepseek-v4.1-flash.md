...
- **Provider:** `parasail/fp8` (pinned, fallbacks disabled)
...
|---|---|---|---|---|
| `openai-completions` | rejected | — | — | rejects `tool_search` — HTTP 400: Provider returned error 400 {'raw': '{"id":"27371903118c67a02eb4ed665cbec05a","error":{"message":"{\\"object\\":\\"error\\",\\"message\\":\\"1 validation error:\\\\n  {\'type\': \'missing... |
