...
- **Provider:** `deepinfra/fp8` (pinned, fallbacks disabled)
...
|---|---|---|---|---|
| `openai-completions` | rejected | — | — | rejects `tool_search` — HTTP 422: Provider returned error 422 {'raw': '{"error":{"message":"Field required","type":"invalid_request_error","param":"tools.4.function.function","code":"missing_required_parameter"}}', 'provi... |
