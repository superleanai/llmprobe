...
- **Provider:** `together` (pinned, fallbacks disabled)
...
|---|---|---|---|---|
| `openai-completions` | rejected | — | — | rejects `tool_search` — HTTP 400: Provider returned error 400 {'raw': '{"error":{"message":"Invalid JSON data: missing field `function`","type":"invalid_request_error","code":"json_parse_error"}}', 'provider_name': 'Toget... |
