...
- **Provider:** `phala` (pinned, fallbacks disabled)
...
|---|---|---|---|---|
| `openai-completions` | error | — | — | HTTP 400: Provider returned error 400 {'raw': '{"error":{"message":"The request was rejected as invalid","type":"invalid_request_error","code":null,"param":null}}', 'provider_name': 'Phala', 'is_by... |
