...
- **Provider:** `fireworks` (pinned, fallbacks disabled)
...
|---|---|---|---|---|
| `openai-completions` | rejected | — | — | rejects `tool_search` — HTTP 400: Provider returned error 400 {'raw': '{"error":{"object":"error","type":"invalid_request_error","code":"invalid_request_error","message":"Input should be \'function\', \'web_search_preview... |
