...
CORS headers were observed, but preflight or the actual response blocks browser-direct access.
...
| Field | Value |
|---|---|
| Allow-origin | preflight or response blocks browser-direct access |
...
- `CORS`: preflight or actual response rejects browser-direct access.
- `TSEL`: no data, please rerun the probing.
