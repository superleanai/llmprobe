...
- **Context window:** 922,000 tokens (max_prompt_tokens, from the endpoint's rejection message)
...
**922,000 tokens** — recovered from the endpoint's rejection message.
...
| Evidence | exceeds the limit of 922000 |
